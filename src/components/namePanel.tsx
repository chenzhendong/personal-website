    ...
    <>
      <div className="shadow rounded-xl overflow-hidden">
        ...
        <div className="pt-14 p-7 bg-white relative">
          <a href="/personal_cv/"><img src="/zhendong.jpg" alt="Avatar" className="user-photo" /> </a>
          <div className="text-2xl font-semibold mb-1.5">Zhendong Chen</div>
          <div className="text-sm text-gray-400 mb-7">Learning is a life style</div>
